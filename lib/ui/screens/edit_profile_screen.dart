...
//forget password nia kaz korba
//profile e image upload diley instant update hoy .
// same update profile e name change korle o instant jatey hoy change.
//task gulay delete  ad kora and api intregate .. jodio eta api e nai .
...
class _EditProfileScreenState extends State<EditProfileScreen> {
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            Expanded(
              child: BodyBackground( //etar jonno import kortey hoicey. import 'package:task_manager/
                        ...
                        SizedBox(
                          ...
                          child: Visibility(
                            ...
                            child: ElevatedButton(
                              //profile update er somoy etar diley progress style buja jay
  ...
  Future<void> updateProfile() async {
    ...
    if (mounted) {
      //etar maney screen e kaz korley tokon set state hoibo .na hoy hobe na.
      setState(() {});
    }
    ...
    if (response.isSuccess) { //cailey akta instant find kore rakha jabey ..
